...
import FixUserButton from '../components/FixUserButton';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <h2 className="text-lg font-semibold mb-4">Fix User Data</h2>
        <p className="text-gray-600 mb-4">
          If you're having trouble with payments, click the button below to fix your user data.
        </p>
        <FixUserButton />
      </div>
